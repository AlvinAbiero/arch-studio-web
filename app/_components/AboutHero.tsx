...
import imageHeroDesktop from "@/public/about/desktop/image-hero.jpg";
import imageHeroTablet from "@/public/about/tablet/image-hero.jpg";
import imageHeroMobile from "@/public/about/mobile/image-hero.jpg";
...
const AboutHero = () => {
  ...
  return (
    ...
    >
      <h1 className="md:absolute top-0 xl:-top-20 lg:-top-4 xl:right-16 lg:right-56 md:right-36 md:top-18 hidden md:block  text-gray-200 xl:text-[20rem] lg:text-[14rem] md:text-[12rem] text-[9rem] font-bold z-40">
        About
      </h1>
